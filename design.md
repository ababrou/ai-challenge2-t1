...
- local mocked data
- Generate at least 20–30 users with enough score variation to produce a realistic leaderboard. User activities must span at least 2 different years so the Year filter has meaningful options.
...
- Generate mock user data (20–30 users, 2+ years of activity data, alternating between the two local avatar files).
